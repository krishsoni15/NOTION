...
/**
 * Action Button Integration Tests Runner
 * 
 * Standalone test runner for action button system integration tests
 * Tests all document types and status combinations
 */
...
function createMockDirectActionItem(type, status, customTitle) {
...
const crossDocumentConsistencyTests = {
...
function runAllTests() {
  console.log("\n╔════════════════════════════════════════════════════════════╗");
  console.log("║   Action Button System Integration Tests                  ║");
  console.log("║   Validates: Requirements 2.1, 2.2, 2.5, 2.6, 2.7, 2.8   ║");
  console.log("╚════════════════════════════════════════════════════════════╝\n");
  ...
  return { passed: totalPassed, failed: totalFailed, allPassed: totalFailed === 0 };
}
