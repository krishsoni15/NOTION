...
import { MapPin, Building, FileText, Calendar, User, X } from "lucide-react";
...
export function LocationInfoDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent showCloseButton={false} className="max-w-md p-0 overflow-hidden bg-card border-none shadow-2xl">
                {/* Header / Cover */}
